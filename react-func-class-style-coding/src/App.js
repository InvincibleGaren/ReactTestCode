...
function App() {
  ...
  return (
    <div className="container">
      ...
      {classShow ? <FuncComp initNumber={2}></FuncComp> : null}
    </div>
  );
}
...
function FuncComp(props) {
  ...
  // var dataState = useState(new Date().toString());
  // var _date = dataState[0];
  // var setDate = dataState[1];
...
class ClassComp extends React.Component {
  ...
  componentWillUpdate(newxProps, nextState) {
